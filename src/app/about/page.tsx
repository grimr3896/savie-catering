...
import { ChefHat, Heart, Star, Loader2, Mail, Phone, MapPin } from 'lucide-react';
            ...
            <div className="md:col-span-2">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Inquiry about wedding catering" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    <CardContent className="pt-6 space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">123 Catering Lane, Foodie City, 12345</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="bg-primary/10 p-3 rounded-full">
